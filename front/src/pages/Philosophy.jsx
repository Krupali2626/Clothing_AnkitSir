            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 md:mb-14">
                    {philosophyCards.map((card) => (
                        <div key={card.title} className="bg-white flex flex-col border border-border">
                    ...
                    <div className="bg-white p-4 md:p-8 border border-border">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:gap-0 gap-4">
                            {pillars.map(({ Icon, title, description }, index) => (
                                <div key={title} className="relative flex flex-col items-center text-center gap-2 px-4 py-6 md:py-0">
                                    {/* Vertical Divider */}
                                    ...
                                    <h4 className="text-xs md:text-sm lg:text-base uppercase font-semibold text-primary tracking-widest">
                                        {title}
                                    </h4>
                    ...
                    <div className="w-full lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                        ...
                        <div>
                            <button
                                ...
                                className="flex items-center gap-2 bg-primary text-white px-4 md:px-6 py-3 md:py-4 text-xs md:text-sm font-semibold uppercase transition-all"
                            >
