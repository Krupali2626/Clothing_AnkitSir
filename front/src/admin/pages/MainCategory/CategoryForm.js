    ...
    <div className="bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden max-w-xl w-full mx-auto">
      <div className="px-8 py-5 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
        <div>
          <h3 className="font-black text-slate-900 text-xl tracking-tight">
            {initialValues ? 'Refine Category' : 'Create New Collection'}
          </h3>
      ...
      <form onSubmit={formik.handleSubmit} className="p-8 space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-sm font-bold text-slate-700 ml-1">Collection Image</label>
        ...
        <div className="grid grid-cols-1 gap-6">
          <div className="space-y-1.5">
            <label htmlFor="mainCategoryName" className="text-sm font-bold text-slate-700 ml-1">
              Category Name
            </label>
            <input
              id="mainCategoryName"
            ...
            />
            {formik.touched.mainCategoryName && formik.errors.mainCategoryName && (
              <p className="text-xs font-bold text-red-500 ml-1 mt-1">{formik.errors.mainCategoryName}</p>
            )}
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 pt-4">
          ...
          >
            ...
            {initialValues ? 'Save Changes' : 'Create Collection'}
          </button>
        </div>
      </form>
    </div>
